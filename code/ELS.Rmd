...
write.csv(CP_frame,file='~/Desktop/COGGPS_PAPER/only_EU/CP_PC(mor)-CPGPS_glm.csv',row.names=FALSE)
write.csv(EA_frame,file='~/Desktop/COGGPS_PAPER/only_EU/EA_PC(mor)-EAGPS_glm.csv',row.names=FALSE)
...
glm_intel_ELS<-function(cog_target,ELS_list,data){
  ...
  file_name<-paste0('~/Desktop/COGGPS_PAPER/only_EU/ELS_' ,cog_target,'_glm.csv')
