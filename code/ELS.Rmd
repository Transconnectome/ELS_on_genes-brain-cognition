...
COV_LIST <- c('age', 'sex','high.educ', 'income', 'married', "race.ethnicity" ,'abcd_site', 'BMI') # should be checked
fact_COV_LIST <- c('age','sex' ,'high.educ', 'income',"factor(race.ethnicity)" ,'factor(married)','factor(abcd_site)', 'BMI') # should be checked
...
cat_var<-c('sex','married' ,'race.ethnicity', 'abcd_site')
con_var<-c('age','high.educ','income','BMI')
#PRS_COV_LIST <- c('PRS_PC1','PRS_PC2','PRS_PC3','PRS_PC4','PRS_PC5','PRS_PC6','PRS_PC7','PRS_PC8','PRS_PC9','PRS_PC10')
...
###preprocessing data
#
all_list<-c('subjectkey','CP','EA','age', 'sex', 'high.educ','race.ethnicity' ,'income','married' ,'abcd_site', 'BMI','nihtbx_totalcomp_uncorrected',	'nihtbx_fluidcomp_uncorrected',	'nihtbx_cryst_uncorrected')
nih_list<-c('nihtbx_totalcomp_uncorrected',	'nihtbx_fluidcomp_uncorrected',	'nihtbx_cryst_uncorrected')
cat_var<-c( 'sex','race.ethnicity','married','abcd_site')
con_var<-c('age','high.educ','income','BMI')
...
for (i in cat_var){
  cov_list<-append(cov_list,paste0("factor(",i,")"))
}#appending categorical and continuousvariable together
cov_list<-append(cov_list,con_var)
cov<- paste(cov_list, collapse=" + ")
